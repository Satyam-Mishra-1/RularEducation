  ...
  return (
    <div className={`primary-container flex flex-row flex-wrap items-center justify-between ${palette} ${text}`}>
                ...
                <div className='md:w-full lg:w-2/5 text-left my-5'>
                    ...
                    <p className='leading-7 my-5 font-comf'>LearnSphere as a platform aims to provide users with seamless learning experience. Our goal is to make quality education and proper information accessible to one and all. Take a step forward to transform your educational journey with us.</p>
